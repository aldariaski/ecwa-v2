"""
Django settings for ecwa project.
...
# (e.g. Heroku).
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-!%yliux^h)q!+$xvfh%@rh0=8ohiq=rr7u5ex3rq1kdh2&p&&c')
...
WSGI_APPLICATION = 'ecwa.wsgi.application'
